import { Brain, FileSearch, FileWarning, Globe2, GraduationCap, LockKeyhole, Network, RadioTower, Shield, ShieldCheck, Smartphone, UserPlus } from "lucide-react";
...
const psychologicalTestsRu = [
  { slug: "primary-selection", title: "Первичный психологический отбор", text: "100 заданий из методики: числовые ряды, закономерности и задачи с изображениями.", icon: Brain, duration: "60 минут", metric: "логическое мышление" }
];

const psychologicalTestsKk = [
  { slug: "primary-selection", title: "Бастапқы психологиялық іріктеу", text: "Әдістемедегі 100 тапсырма: сандық қатарлар, заңдылықтар және суреті бар тапсырмалар.", icon: Brain, duration: "60 минут", metric: "логикалық ойлау" }
];
