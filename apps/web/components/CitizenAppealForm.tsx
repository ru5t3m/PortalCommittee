...
const copy = {
  ru: {
    ...
    authRequiredText: "Заявка на поступление доступна только пользователям, которые вошли в профиль. Войдите по email, затем вернитесь к форме.",
    login: "Войти",
    statusLabels: {
      received: "Получено",
  ...
  kk: {
    ...
    authRequiredText: "Оқуға немесе қызметке өтінім беру портал профиліне кірген пайдаланушыларға ғана қолжетімді. Email арқылы кіріп, нысанға қайта оралыңыз.",
    login: "Кіру",
    statusLabels: {
      received: "Қабылданды",
      in_review: "Қаралуда",
